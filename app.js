// /* CHAPTER 01 */
// /* Q1 */
// window.alert("Welcome Dear Valuable customer")
...
// /* Q4 */
// var name = 'muhammad huzaifa'
// var age = 20
// var prof = 'python programmer'
// window.alert(name)
// window.alert(age)
// window.alert(prof)
...
// /* Q6 */
// var email = "mhuzaifa@students.uit.edu"
...
// var prod = "Shirt"
// var quant = 2
// document.write(vis + " ordered " + quant + " " + prod +"(s)" + " on Zepper clothing store")
...
// var objstyd = {}
// /* 3 */
// var sa = ['Muhammad','huzaifa','khalid']
// /* 4 */
// var na = [0,3,1]
// /* 5 */
// var ba = [true,false]
// /* 6 */
// var ma = ['farhan',2,true]
// /* 7 */
// var qualification = ['SSC','HSC','BCS','BS','BCOM','MS','M.Phil.','PhD']
// /* 8 */
// var names = ['huzaifa','zohair','sarim']
